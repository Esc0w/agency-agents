...
> 🇫🇷 **Branche française `FR`** — Consultez le [guide français](README.fr.md) et le [catalogue des agents](CATALOGUE.fr.md). Les fiches de cette branche sont adaptées en français ; leurs identifiants techniques restent inchangés.
